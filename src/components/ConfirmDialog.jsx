      ...
      {isOpen && (
        <>
          ...
          <motion.div 
            ...
            className="fixed bottom-0 left-0 right-0 z-50 bg-white dark:bg-[#1a1a2e] rounded-t-3xl shadow-2xl p-6 md:p-8 max-w-md mx-auto md:bottom-auto md:top-1/2 md:-translate-y-1/2 md:rounded-3xl"
          >
            <div className="flex flex-col items-center text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-3 w-full">
                <button 
                  onClick={onCancel}
                  className="flex-1 py-3.5 px-4 rounded-xl font-bold text-main/70 bg-black/5 hover:bg-black/10 dark:bg-white/5 dark:hover:bg-white/10 transition-colors"
                >
                  {cancelText}
                </button>
                <button 
